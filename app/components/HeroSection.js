  ...
  return (
    <div className="h-screen w-full flex justify-center items-center">
      ...
      <div className="h-screen w-full bg-[#1414149d] absolute z-10 flex justify-center items-center max-md:justify-end flex-col">
        <h3 className="text-center text-[50px] max-md:text-[35px] font-semibold text-[#0e9753]">
        ...
        <div className="w-full flex justify-center items-center max-md:justify-end">
          <Link href="/shop" className="h-12.5 max-md:h-15 w-62.5 bg-[#0e9753] m-5 max-md:mb-5 max-md:mr-0 rounded-bl-4xl rounded-br-4xl rounded-tl-4xl rounded-tr-4xl max-md:rounded-br-0 max-md:rounded-br-none max-md:rounded-tr-none flex flex-row justify-start items-center">
