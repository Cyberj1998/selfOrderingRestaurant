...
const DiscountSection = () => {
  return (
    <div className='h-75 z-10 max-md:h-37.5 w-[85%] mt-20 max-md:mt-15 max-sm:mt-1 bg-linear-to-r from-[#0e9753] to-[#59e1a9] rounded-[50px] flex flex-row justify-evenly items-center p-5'>
